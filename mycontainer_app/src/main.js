...
const RegisterContainerForm = require('./views/register_container_form')
const Dashboard = require('./views/dashboard')
const LoginForm = require('./views/login_form')
const AContainerList = require('./views/container_list')
const ContainerDetailPage = require('./views/Container_detail')
...
const loggedInNav = () => {
  const links = [
    ...
    ['/containers', 'View Container Registry'],
    ['/agents', 'View Agents']
  ]
...
document.addEventListener('DOMContentLoaded', () => {
  m.route(document.querySelector('#app'), '/', {
    ...
    '/register': resolve(RegisterContainerForm, true),
    '/login': resolve(LoginForm),
    '/logout': { onmatch: logout },
    '/profile': { onmatch: profile},
    '/containers': resolve(ContainerList),
    '/containers/:recordId': resolve(ContainerDetailPage),
